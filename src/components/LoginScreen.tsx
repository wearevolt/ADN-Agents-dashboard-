      ...
      <Card className="w-full max-w-md relative z-20 bg-white/95 backdrop-blur-sm border border-gray-200 shadow-lg">
        <CardHeader className="space-y-1">
          <div className="flex justify-center mb-2">
            <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="#3b3e45" viewBox="0 0 256 256">
          ...
          <CardTitle className="text-2xl font-bold text-center text-gray-900">Welcome to Agents Dashboard</CardTitle>

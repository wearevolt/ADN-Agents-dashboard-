      ...
      {isEditing ? (
        <div className="flex w-full items-center gap-1">
          <input
            ...
            className="flex h-9 w-full items-center text-ellipsis rounded-xl border border-gray-200 bg-white p-3 text-xs font-medium text-gray-900 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-gray-300"
            autoFocus
          />
          <Button
            variant="ghost"
          ...
          >
            <Icon type="save" size="xs" className="text-gray-700" />
          </Button>
        </div>
      ) : (
        <div className="flex w-full items-center gap-1">
          <motion.div
            className="relative flex h-9 w-full cursor-pointer items-center justify-between rounded-xl border border-gray-200 bg-white p-3 uppercase"
          ...
          >
            ...
            >
              <Icon type="refresh" size="xs" className="text-gray-700" />
            </motion.div>
          </Button>
        </div>
      )}
...
const Sidebar = ({ initialCollapsed = false }: SidebarProps) => {
  ...
  return (
    <motion.aside
      className="relative flex h-screen shrink-0 grow-0 flex-col overflow-hidden px-2 py-3 font-dmmono bg-white border-r border-gray-200"
      initial={{ width: "16rem" }}
    ...
    >
      ...
      >
        <Icon
          type="sheet"
          size="xs"
          className={`transform ${isCollapsed ? "rotate-180" : "rotate-0"} text-gray-700`}
        />
      </motion.button>
      <motion.div

...
const ReferenceItem: FC<ReferenceItemProps> = ({ reference }) => (
  <div className="relative flex h-[63px] w-[190px] cursor-default flex-col justify-between overflow-hidden rounded-md bg-gray-100 p-3 transition-colors hover:bg-gray-200">
...
const Reasoning: FC<ReasoningStepProps> = ({ index, stepTitle }) => (
  <div className="flex items-center gap-2 text-gray-600">
    <div className="flex h-[20px] items-center rounded-md bg-gray-100 p-2">
      <p className="text-xs text-gray-700">STEP {index + 1}</p>
    </div>

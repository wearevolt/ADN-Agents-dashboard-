      ...
      <CardContent className="space-y-4">
        ...
        <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
          ...
          <p className="text-sm text-yellow-700">
            Хост <code>api.agno.ai</code> недоступен. Agno - это локальный фреймворк, 
            нужно запустить сервер локально.
          </p>
        </div>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <ol className="text-sm text-blue-700 list-decimal list-inside space-y-1">
            <li>Установите: <code>pip install agno</code></li>
            <li>Создайте Python файл с агентом</li>
            <li>Запустите: <code>agno serve --port 7777</code></li>
            <li>Используйте endpoint: <code>http://localhost:7777</code></li>
          </ol>
        </div>
      </CardContent>
    </Card>
